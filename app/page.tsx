...
const collections = [
  { title: "Dresses", subtitle: "Made for every plan", image: "sheet-one q1", href: "/collections/dresses" },
  { title: "Tops & Blouses", subtitle: "Elevated everyday layers", image: "sheet-one q2", href: "/collections/tops-blouses" },
  { title: "Bags", subtitle: "The finishing touch", image: "sheet-two q1", href: "/collections/bags" },
];
    ...
    <main>
      ...
      <section className="explore section shell">
        ...
        <div className="explore-grid">
          <Link href="/collections/dresses" className="explore-card sheet-one q3"><div><h3>Dresses</h3><span>Shop the edit</span></div></Link>
          <Link href="/collections/rompers-playsuits" className="explore-card sheet-two q2"><div><h3>Rompers & Playsuits</h3><span>Shop the edit</span></div></Link>
          <Link href="/collections/shoes" className="explore-card sheet-two q3"><div><h3>Shoes</h3><span>Shop the edit</span></div></Link>
        </div>
      </section>
      ...
      <section className="journal section shell">
        ...
        <div className="journal-grid">
          <article><div className="journal-photo sheet-one q1"/><p>THE EDIT</p><h3>What to wear from brunch to golden hour</h3><Link href="/journal/brunch-to-golden-hour">Read the story</Link></article>
          <article><div className="journal-photo sheet-two q1"/><p>ACCESSORIES</p><h3>The everyday bag, perfected</h3><Link href="/journal/the-everyday-bag">Read the story</Link></article>
          <article><div className="journal-photo sheet-one q4"/><p>STYLE GUIDE</p><h3>Five pieces, endless possibilities</h3><Link href="/journal/five-pieces-endless-possibilities">Read the story</Link></article>
        </div>
      </section>

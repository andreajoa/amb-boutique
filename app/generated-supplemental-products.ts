...
function bag(slug: string, name: string, price: number, color: string, colorName: string, stock: number, weightOz: number, unitCostUsd: number, image: string, gallerySprite?: Product["gallerySprite"], galleryAtlasIndex?: number): Product {
  return {
    ...
    ...(typeof galleryAtlasIndex === "number" ? { galleryAtlasIndex, galleryAtlasCount: 10 } : {}),
    stock,
    weightOz,
    unitCostUsd,
...
const bagCatalog: Product[] = [
  ...
  bag("noir-lace-crossbody-black", "Noir Lace Crossbody — Black", 49, "#171717", "Black", 28, 6.31, 6.81, USER_EDITORIAL_ATLAS, USER_EDITORIAL_GALLERY, 0),
  bag("camille-multi-pocket-crossbody-black", "Camille Multi-Pocket Crossbody — Black", 59, "#171717", "Black", 962, 9.88, 8.54, USER_EDITORIAL_ATLAS, USER_EDITORIAL_GALLERY, 1),
  bag("camille-multi-pocket-crossbody-green", "Camille Multi-Pocket Crossbody — Green", 59, "#4d6b5b", "Green", 1, 9.88, 9.86, USER_EDITORIAL_ATLAS, USER_EDITORIAL_GALLERY, 2),
  ...
  bag("siena-signature-satchel-kangaroo-brown", "Siena Signature Satchel — Kangaroo Brown", 98, "#91694a", "Kangaroo Brown", 1, 26.49, 34.12, USER_EDITORIAL_ATLAS, USER_EDITORIAL_GALLERY, 3),
